...
import FaqCategoryItem from "../../components/Items/FaqCategoryItem";
...
const FaqCategory = () => {
  ...
  return (
    <>
      <div className="page-filter mb-3">
        <div className="input-filters">
          ...
          <div className="input-items items-end ms-auto gap-3">
            ...
            <Button label={"Add FAQ Category"} labelClasses={""} classes={""} icon={"fa-regular fa-plus"} iconPosition={"left"} functions={addModal} />
          </div>
        </div>
      ...
      <Modal title={"Add FAQ Category"} size={"md"} isOpen={isAddModal} modalClose={() => setIsAddModal(!isAddModal)}>
        <AddCategory />
      </Modal>
    </>
  );
